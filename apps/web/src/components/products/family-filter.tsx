...
const CHIP_BASE =
	"rounded-full border border-brand/28 px-4.5 py-2 font-sans text-[0.8125rem] font-semibold transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-bright";
